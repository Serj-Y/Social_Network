  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className={styles.editModeForm}>
        <b> Full Name</b>:{" "}
        {CreateFields<ProfileTypeKeys>("Full name", "fullName", [], Input)}
      </div>
      <div className={styles.editModeForm}>
        <b>About Me</b>:{" "}
        {CreateFields<ProfileTypeKeys>("About Me", "aboutMe", [], Textarea)}
      </div>
      <div className={styles.editModeForm}>
        <b> Looking for a Job?</b>:
        {CreateFields<ProfileTypeKeys>("", "lookingForAJob", [], Input, {
          type: "checkbox",
        })}
      </div>
      <div className={styles.editModeForm}>
        <b>Looking a Job</b>:
        {CreateFields<ProfileTypeKeys>(
        ...
        {Object.keys(profile.contacts).map((key) => {
          return (
            <div key={key} className={styles.contacts}>
              <b className={styles.editModeForm}>
                {key}: {CreateFields(key, "contacts." + key, [], Input)}
              </b>
            </div>
          );
        })}
