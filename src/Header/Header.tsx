  ...
  return (
    <header className={styles.header}>
        ...
        <div className={styles.burger}>
          <nav className={styles.nav}>
            <div className={styles.item}>
              ...
              />
              <Btn
                Click={() => setBurgerBtn(false)}
                ButtonText={<FontAwesomeIcon icon={faXmark} />}
              />
            </div>
          </nav>
        </div>
      ...
      <div className={styles.loginBlock}>
        {isAuth ? (
          <Btn
            PropBtnStyle={styles.propBtn}
            Click={LogOut}
            ButtonText={<FontAwesomeIcon icon={faRightFromBracket} />}
          />
        ) : (
          <NavBtn
            PropBtnStyle={styles.propBtn}
            Href="/login"
            ButtonText={<FontAwesomeIcon icon={faRightToBracket} />}
          />
        )}
      </div>
    </header>
